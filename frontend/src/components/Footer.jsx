    ...
    <footer id="kontak" className="bg-green-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              {/* Facebook Icon */}
              <a href="#" className="w-8 h-8 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3 text-green-200">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span>info@tpqasyasyafii.sch.id</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
                <span>Jl. Pendidikan No. 123, Campakoah</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-green-700 mt-8 pt-8 text-center text-green-200">
          <p>&copy; 2025 TPQ Asy-Syafi'i Campakoah. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
